...
function getUri(src) {
    ...
    if (uri.indexOf(utils_1.RESOURCE_PREFIX) === 0) {
        var resName_1 = uri.substr(utils_1.RESOURCE_PREFIX.length);
        if (screenScale === -1) {
    ...
    Img.prototype.getUIImage = function (path) {
        ...
        if (typeof path === 'string') {
            if (utils_1.isFileOrResourcePath(path)) {
                image = image_source_1.ImageSource.fromFileOrResourceSync(path);
            }
        }
        else {
            image = path;
            ...
            if (src) {
                if (src instanceof image_source_1.ImageSource) {
                    ...
                    if (fontIconCode !== undefined) {
                        ...
                        this._setNativeImage(image_source_1.ImageSource.fromFontIconCodeSync(fontIconCode, font, color).ios);
                    }
                    return;
                }
                if (this.noCache) {
