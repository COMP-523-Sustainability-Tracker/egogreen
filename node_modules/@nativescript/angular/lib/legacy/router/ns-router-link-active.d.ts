...
export declare class NSRouterLinkActive implements OnChanges, OnDestroy, AfterContentInit {
    ...
    static ɵdir: i0.ɵɵDirectiveDeclaration<NSRouterLinkActive, "[nsRouterLinkActive]", ["routerLinkActive"], { "nsRouterLinkActiveOptions": { "alias": "nsRouterLinkActiveOptions"; "required": false; }; "nsRouterLinkActive": { "alias": "nsRouterLinkActive"; "required": false; }; }, {}, ["links"], never, false, never>;
}
