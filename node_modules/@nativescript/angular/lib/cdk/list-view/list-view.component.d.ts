import { AfterContentInit, ChangeDetectorRef, DoCheck, ElementRef, EmbeddedViewRef, EventEmitter, InjectionToken, IterableDiffer, IterableDiffers, NgZone, OnDestroy, TemplateRef, ViewContainerRef } from '@angular/core';
...
export declare class ListViewComponent<T = any> implements DoCheck, OnDestroy, AfterContentInit, TemplatedItemsHost {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<ListViewComponent<any>, "ListView", never, { "items": { "alias": "items"; "required": false; }; }, { "setupItemView": "setupItemView"; }, ["itemTemplateQuery"], never, false, never>;
}
...
export declare class TemplateKeyDirective<T> {
    ...
    static ɵdir: i0.ɵɵDirectiveDeclaration<TemplateKeyDirective<any>, "[nsTemplateKey],[nsTemplateKeys]", never, { "nsTemplateKey": { "alias": "nsTemplateKey"; "required": false; }; "nsTemplateKeys": { "alias": "nsTemplateKeys"; "required": false; }; }, {}, never, never, false, never>;
}
